...
<body>
          ...
          <div class="container">
               ...
               <!--          <li><a href="login.php" class="smoothScroll">Login</a></li>-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <a href="#contact" class="section-btn">Sign in</a>
                    </ul>
               </div>
  ...
  -->
                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form action="inserts.php" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
                              ...
                              <p>
                                   New User? <a href="home.php">Create Profile</a>
                              </p>
                         </form>
                    </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-8">
                         <div class="footer-info">
                              <div class="section-title">
                                   <h2 class="wow fadeInUp" data-wow-delay="0.2s">About us</h2>
                              </div>
                              <address class="wow fadeInUp" data-wow-delay="0.4s">
